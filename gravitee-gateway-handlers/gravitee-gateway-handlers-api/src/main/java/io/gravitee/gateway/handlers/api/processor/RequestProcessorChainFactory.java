...
import io.gravitee.gateway.handlers.api.processor.forward.XForwardPrefixProcessor;
...
public class RequestProcessorChainFactory extends ApiProcessorChainFactory {
    ...
    @Value("${handlers.request.headers.x-forwarded-for.use-context-path:false}")
    ...
    public void afterPropertiesSet() {
        ...
        if (overrideXForwardedPrefix) {
            providers.add(new ProcessorSupplier<>(() ->
                    new StreamableProcessorDecorator<>(new XForwardPrefixProcessor())));
        }
